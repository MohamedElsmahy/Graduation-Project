...
const JobsList = () => {
  ...
  return (
    <div>
      <Card  style={{width:1250,marginRight:'auto',marginLeft:'auto',marginTop:90,marginBottom:30,}}>
       <Grid container style={{gap:50}}>
         <Grid item xs={12} md={3}>
           <Paper elevation={5} style={paperstyle}>
             <h2 style={{padding:10,fontWeight:'bold',fontSize:30,marginBottom:1}}>filter</h2>
            ...
            <Button type="submit" variant="contained" disableElevation style={{background:'#4caf50',color:"white",padding:15,fontWeight:'bold',fontSize:15,margin:5,width:260}}>
                 Search
             </Button>
             </form>
      ...
      <CardActions disableSpacing>
        <IconButton aria-label="add to favorites" color="secondary" style={icon}>
          <FavoriteIcon />
        </IconButton>
        
        <Button type="submit" variant="contained" disableElevation style={button}>
                 Apply Now
             </Button>
